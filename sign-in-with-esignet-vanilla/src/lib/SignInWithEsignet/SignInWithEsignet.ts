...
const createButton = (
  ...
  outerDiv.classList.add(buttonClasses.outerDivClasses);

  var logoDiv = document.createElement("div");
  logoDiv.classList.add(buttonClasses.logoDivClasses);

  var logoImg = document.createElement("img");
  logoImg.classList.add(buttonClasses.logoImgClasses);
  logoImg.src = logoPath;

  var labelSpan = document.createElement("span");
  labelSpan.classList.add(buttonClasses.labelSpanClasses);
